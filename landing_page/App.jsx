...
const App = () => {
    ...
    return (<div className="relative min-h-screen bg-dengue-dark text-slate-200 selection:bg-dengue-primary selection:text-white overflow-hidden">
      ...
      <div className="fixed inset-0 z-[1] pointer-events-none overflow-hidden">
        ...
        <motion.div style={{ y: y1 }} className="absolute top-0 left-0 w-full h-full opacity-15">
          {[...Array(6)].map((_, i) => (<div key={i} className="absolute rounded-full mix-blend-screen blur-3xl animate-pulse-glow" style={{
