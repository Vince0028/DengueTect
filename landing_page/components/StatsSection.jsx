...
const StatsSection = () => {
    ...
    return (<section className="py-10 relative z-10">
      <div className="container mx-auto px-6">
        <div className="glass-card rounded-3xl p-10 md:p-12 border-t border-dengue-primary/20 shadow-[0_0_50px_-10px_rgba(22,163,74,0.1)]">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-y md:divide-y-0 md:divide-x divide-white/5">
            {stats.map((stat, index) => (<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} viewport={{ once: true }} key={index} className="text-center group pt-8 md:pt-0 first:pt-0">
