...
const Education = () => {
    ...
    return (<section id="education" className="py-20 md:py-32 relative bg-black/20">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-3xl md:text-5xl font-display font-bold mb-6 text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {facts.map((fact, index) => (<motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="glass-card rounded-2xl p-6 md:p-8 hover:border-dengue-primary/30 transition-colors group">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mt-16 glass-card rounded-2xl p-8 md:p-12 text-center">
          ...
          <a href="https://doh.gov.ph" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-3 bg-dengue-primary hover:bg-dengue-glow text-dengue-dark font-bold rounded-xl transition-colors">
            Visit DOH Website
          </a>
        </motion.div>
      </div>
