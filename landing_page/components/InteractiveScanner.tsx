...
const InteractiveScanner: React.FC = () => {
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        >
                        ...
                        {!scanComplete && (
                            <>
                                <motion.div 
                                    ...
                                    className="absolute left-0 right-0 h-1 bg-dengue-glow shadow-[0_0_20px_rgba(74,222,128,1)] z-20"
                                />
            ...
            <motion.div
                ...
                className="absolute bottom-8 left-4 right-4 bg-dengue-dark/95 backdrop-blur-xl rounded-2xl md:rounded-3xl border border-dengue-glow/30 p-5 md:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col"
            >
