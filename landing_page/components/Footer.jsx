...
const Footer = () => {
    ...
    return (<React.Fragment>
      {activeModal && (<div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#0f172a] border border-white/10 rounded-2xl max-w-md w-full max-h-[80vh] overflow-y-auto shadow-2xl">
            <div className="sticky top-0 bg-[#0f172a] border-b border-white/10 p-4 flex items-center justify-between">
              ...
              <button onClick={() => setActiveModal(null)} className="p-2 hover:bg-white/10 rounded-lg transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-1 space-y-4">
              ...
              <div className="flex gap-4 pt-2">
                {[Twitter, Github, Linkedin].map((Icon, i) => (<a key={i} href="#" className="text-slate-500 hover:text-dengue-glow transition-colors">
            ...
            <div className="md:col-span-2 grid grid-cols-2 gap-4">
              {footerLinks.map((item) => (<button key={item.code} onClick={() => setActiveModal(item.label)} className="group flex items-center justify-between p-3 rounded-lg bg-white/5 hover:bg-dengue-primary/10 border border-white/5 hover:border-dengue-primary/30 transition-all text-left">
