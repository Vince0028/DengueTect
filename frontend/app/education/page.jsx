...
import { ArrowLeft, BookOpen, MapPin, Phone, Clock, AlertTriangle, Shield, Droplets, Thermometer, Users, } from "lucide-react";
          ...
          <Card className="border-emerald-200 dark:border-gray-700 dark:bg-gray-800">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                <Button variant="outline" className="w-full justify-start bg-white dark:bg-gray-700 dark:text-white dark:border-gray-600">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <Button variant="outline" className="w-full justify-between bg-white dark:bg-gray-700 dark:text-white dark:border-gray-600 h-auto p-3">
