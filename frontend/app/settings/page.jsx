...
export default function SettingsPage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 dark:bg-black">
      <DashboardHeader />
          ...
          <Card className="border-emerald-200 dark:border-emerald-800 dark:bg-gray-900">
            <CardHeader className="pb-3">
              <CardTitle className="text-lg flex items-center dark:text-white">
                {theme === "dark" ? (<Moon className="mr-2 h-5 w-5 text-emerald-600"/>) : (<Sun className="mr-2 h-5 w-5 text-emerald-600"/>)}
                Appearance
              </CardTitle>
            </CardHeader>
