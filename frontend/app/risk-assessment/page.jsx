            ...
            <div className="flex justify-center">
              <div className="relative w-32 h-32">
                <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 36 36">
                  ...
                  <path className={getRiskColor(currentRisk)} stroke="currentColor" strokeWidth="3" strokeDasharray={`${riskPercentage}, 100`} strokeLinecap="round" fill="transparent" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"/>
                </svg>
