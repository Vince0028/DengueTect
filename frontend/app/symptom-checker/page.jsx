    ...
    return (<div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-6 max-w-md">
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center space-x-3 p-4 border rounded-lg">
                <Checkbox id={currentSymptom?.id} checked={selectedSymptoms.includes(currentSymptom?.id || "")} onCheckedChange={() => handleSymptomToggle(currentSymptom?.id || "")}/>
              ...
              <div className="flex space-x-3">
                <Button variant="outline" onClick={handleBack} disabled={currentStep === 1} className="flex-1 bg-transparent">
          ...
          {selectedSymptoms.length > 0 && (<Card>
              <CardHeader>
              ...
              <CardContent>
                ...
                return (<span key={symptomId} className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">
                        {symptom?.label}
                      </span>);
            })}
                </div>
